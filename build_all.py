...
if __name__ == "__main__":
    for i in range(6):
        ...
        with open(f"params{i}.yaml") as file:
        ...
        # sample inputs
        _, seq_len, emb_dim = np.load(f"outputs/{i}/inp.npy").shape
        ...
        cfg = build_cfg.DataflowBuildConfig(
            ...
            **params["build"],
            ...
            verify_input_npy=f"outputs/{i}/inp.npy",
            # File with expected test outputs for verification
            verify_expected_output_npy=f"outputs/{i}/out.npy",
        ...
        build.build_dataflow_cfg(f"outputs/{i}/model.onnx", cfg)
